  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-between bg-[#115c8f] pt-16  py-32">
      ...
      >
        ...
        <div className="flex justify-start space-x-3 px-10 text-white  ">
          <Link
      ...
      <div className="">
        <p className="text-white text-center font-bold text-3xl">
          Bangladesh Shisu Academy, Doyel Chattor, <br /> Shabag, Dhaka-1000
        </p>
      </div>

      <div className="text-white font-bold mt-16 px-10">
        <p>@2023 by.</p>
        <p>Proudly created with Bijoy</p>
      </div>
    </div>
  );
};
